...
Your goal is to gather **specific, relevant single-item products** matching the user's query. (Avoid multi-packs, bulk cases, or generic category pages.)
...
**Instructions:** 
- **Filter Irrelevant or Duplicate Entries:** Ignore products that are irrelevant, in the wrong language, or exact duplicates. Each product you return should be unique by **title + brand + quantity** (no repeats).

...
5. If the product title provided in the input is slightly incorrect (e.g. a word is missing or the order of words is wrong), return the correct title based on your search and knowledge. Do not simply copy the input title if it is not correct. Correct the title where necessary.
6. Extract the following details from the nutrition info you obtained:
   - Product title
   - Brand

...
Please keep in mind that the user has controls at the bottom of the camera view, so they might tend to center objects slightly toward the top; if this is not extreme, it is fine. Just make sure it's within the frame, it can be towards the top or bottom.
...
If you don't see any food or products, just return 'Er is geen voedsel of product gedetecteerd'; don't assume it's being blocked by something. Most of the time the image is simply empty. In almost every case of confusion or non-food related items return "Er is geen voedsel of product gedetecteerd" feedback.
`;
